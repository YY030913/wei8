...
<ul class="nav nav-tabs">
	...
	<li <?php  if($operation == 'display' && $status == '1' && ( $sendtype=='1' || $sendtype=='0')) { ?> class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('order', array('op' => 'display', 'status' => 1))?>">待发货</a>
	</li>
	<li <?php  if($operation == 'display' && $status == '1' && $sendtype == '2') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('order', array('op' => 'display', 'status' => '1', 'sendtype' => 2))?>">待自提</a>
	</li>
		...
		<div class="panel-body table-responsive">
			<table class="table table-hover">
				...
				<tr>
					...
					<td><?php  if($item['sendtype'] == '3') { ?>无需配送<?php  } else if($item['sendtype'] == '2') { ?>自提<?php  } else { ?><?php  echo $item['dispatch'];?><?php  } ?></td>
					<td><?php  echo $item['dispatchprice'];?></td>
					<td><?php  echo $item['price'];?> 元</td>
					<td>
						<span class="label <?php  if($item['goodstype'] == '2' && $item['status'] == '待发货' ) { ?>label-success<?php  } else { ?>label-<?php  echo $item['statuscss'];?><?php  } ?>"><?php  if($item['goodstype'] == '2' && $item['status'] == '待发货' ) { ?>完成<?php  } else { ?><?php  echo $item['status'];?><?php  } ?></span>
                    </td>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">付款方式 :</label>
					<div class="col-sm-9 col-xs-12">
						<p class="form-control-static"><?php  echo $item['paydetail'];?></p>
					</div>
				</div>
				<?php  } ?>
				<div class="form-group">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<p class="form-control-static"><?php  echo $item['user']['0'];?></p>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">手机 :</label>
					<div class="col-sm-9 col-xs-12">
						<p class="form-control-static"><?php  echo $item['user']['1'];?></p>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">地址 :</label>
					<div class="col-sm-9 col-xs-12">
						<p class="form-control-static"><?php  echo $item['user']['3'];?><?php  echo $item['user']['4'];?><?php  echo $item['user']['5'];?><?php  echo $item['user']['6'];?></p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="panel-body table-responsive">
				<table class="table table-hover">
					...
					<tr>
						...
						<td><?php  echo $goods['marketprice'];?>元 / <?php  echo $goods['productprice'];?>元</td>
